...
- [update GOV.UK Frontend](https://frontend.design-system.service.gov.uk/staying-up-to-date/)

## Using the HTML test files

If you [installed GOV.UK Frontend with Node.js package manager (npm)](https://frontend.design-system.service.gov.uk/installing-with-npm/), you can find the `fixtures.json` file for each component in the `node_modules/govuk-frontend/dist/govuk/components/COMPONENT-NAME/` folder, where `COMPONENT-NAME` is the name of the component.

...
Read more on upgrading your version of GOV.UK Frontend in our guidance on [staying up to date with changes](https://frontend.design-system.service.gov.uk/staying-up-to-date/).
...
You can use the [Generic header component](https://design-system.service.gov.uk/components/generic-header/) to create a header for your service without the GOV.UK branding. 
...
Read our guidance on [extending and modifying components in production](https://design-system.service.gov.uk/get-started/extending-and-modifying-components/) for details on how to customise your header.
...
- [`$govuk-font-family`](https://frontend.design-system.service.gov.uk/sass-api-reference/#govuk-font-family)
- [`$govuk-functional-colours`](https://frontend.design-system.service.gov.uk/sass-api-reference/#govuk-functional-colours) 

You can use [Sass’s `@use… with` syntax](https://sass-lang.com/documentation/at-rules/use/#configuration) when including GOV.UK Frontend in your Sass:
...
You can redefine `$govuk-functional-colours` and change your brand colour using the [`$govuk-functional-colours` redefinition syntax](https://frontend.design-system.service.gov.uk/sass-api-reference/#example-redefining-functional-colours-by-setting-them-before-import). For example, to change your service’s brand colour to green (`#388E3C`), include the following inside your GOV.UK Frontend `@use … with` statement:
...
You can either use colours from our [web palette](https://design-system.service.gov.uk/styles/colour/#govuk-web-palette) or use your own colours. 
## Using your own image assets

When you’re not using GOV.UK branding, you must replace the following [assets from GOV.UK Frontend](https://frontend.design-system.service.gov.uk/import-font-and-images-assets/) with your own branded assets:

- [favicons](#favicons)
- [mobile homepage icons](#mobile-homepage-icons)
- [sharing image](#sharing-image)

To replace these assets with your own assets, you can either include your own assets in an `assets/images` folder in your service or [specify your own asset path](https://frontend.design-system.service.gov.uk/import-font-and-images-assets/#if-you-have-your-own-folder-structure), which GOV.UK Frontend will automatically use.
...
The GOV.UK Frontend template uses the [`theme-color` meta attribute value](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/meta/name/theme-color), which sets the toolbar colour on some devices.

If you’re using the GOV.UK Frontend Nunjucks [page template](https://design-system.service.gov.uk/styles/page-template/), set the `themeColor` template variable so it does not use the GOV.UK brand blue: 

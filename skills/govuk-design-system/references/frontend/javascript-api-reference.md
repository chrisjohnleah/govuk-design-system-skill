...
- [when configuring instances of specific components](https://frontend.design-system.service.gov.uk/configure-components/#configure-instances-of-specific-components-using-the-createall-function)
- [when configuring all components using the `initAll` function](https://frontend.design-system.service.gov.uk/configure-components/#configure-all-components-using-the-initall-function)
...
messages](https://frontend.design-system.service.gov.uk/localise-govuk-frontend/#understanding-pluralisation-rules).
...
Messages the component uses for screen reader announcements relating to the

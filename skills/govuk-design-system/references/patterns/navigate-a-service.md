...
Use this pattern to plan and design your navigation header using the [GOV.UK header component](https://design-system.service.gov.uk/components/header/) and [Service navigation component](https://design-system.service.gov.uk/components/service-navigation/). Check the ‘When to use this component’ sections in each of these components to make sure they’re right for your service.
...
Together, the [GOV.UK header component](https://design-system.service.gov.uk/components/header/) and [Service navigation component](https://design-system.service.gov.uk/components/service-navigation/) work together to assure users that they’re in the right place to use your service. They also help users understand that GOV.UK functions as one website.
...
The [GOV.UK header component](https://design-system.service.gov.uk/components/header/) should only be used to show the GOV.UK logo and any GOV.UK-wide tools used in your service, such as GOV.UK One Login.

If you need to show your service name or add navigation links, use the [Service navigation component](https://design-system.service.gov.uk/components/service-navigation/).
...
Once users enter your service, they should have all the information they need to complete it [from your service's Start page](https://design-system.service.gov.uk/patterns/start-using-a-service/). If you need to refer to specific information as part of your service’s journey, use links within your pages.

### Plan your Service navigation

Use the [Service navigation component](https://design-system.service.gov.uk/components/service-navigation/) to show your service name, navigation links and other service-level tools.
...
If you provide your whole service in more than one language, you can place the [Language navigation component in the Service navigation](https://design-system.service.gov.uk/components/language-navigation/#if-you-offer-your-whole-service-in-another-language).

#### Use ‘slots’ to add custom elements

The [Service navigation component includes ‘slots’](https://design-system.service.gov.uk/components/service-navigation/#use-slots-to-add-custom-html-code) to support adding custom elements. You’ll need to decide on the most appropriate layout and positioning and provide your own styles.
...
Show the [Phase banner component](https://design-system.service.gov.uk/components/phase-banner/) directly under either:
...
If your service uses the [Breadcrumbs component](https://design-system.service.gov.uk/components/breadcrumbs/), place them just before the `<main>` element. Placing them here means that the ‘Skip to main content’ link allows the user to skip all navigation links, including breadcrumbs.

## How the GOV.UK header and Service navigation work together

We introduced this pattern and the [Service navigation component](https://design-system.service.gov.uk/components/service-navigation/) in August 2024. You can no longer use the GOV.UK header to show service name or navigation links.

...
**Example: Contact a department or service team**
...
**Example: Contact a department or service team** second
...
Use the [Inset text component](https://design-system.service.gov.uk/components/inset-text/) to display contact information when you want to differentiate it from the content that surrounds it.

**Example: Contact information inset text**
...
If contact information is less important than other content on a page, you can enclose contact information inside the [Details component](https://design-system.service.gov.uk/components/details/) to avoid distracting users.
...
**Example: Contact information details component**

...
Before using this pattern, you should consider whether you really need users to [create accounts in your service](https://design-system.service.gov.uk/patterns/create-accounts/) in the first place.

...
You should follow this pattern whenever you need users to create or enter a password. Before using this pattern, you should also read the guidance on the [User accounts pattern](https://design-system.service.gov.uk/patterns/create-accounts/).

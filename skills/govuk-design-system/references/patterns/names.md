...
<div class="govuk-form-group">
  ...
  <input
   class="govuk-input" id="full-name" name="fullName" type="text" spellcheck="false" autocomplete="name">
</div>
```
...
It’s also hard to predict the range of titles your users will have. If you have to ask for someone’s title, use an optional [Text input component](https://design-system.service.gov.uk/components/text-input/) not a [Select component](https://design-system.service.gov.uk/components/select/).
...
**Example: Name input with errors**
...
<div class="govuk-form-group govuk-form-group--error">
  ...
  <input
   class="govuk-input govuk-input--error" id="full-name" name="fullName" type="text" spellcheck="false" aria-describedby="full-name-error" autocomplete="name">
</div>
```

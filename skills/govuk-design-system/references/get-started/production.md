...
<div class="govuk-warning-text app-table--constrained">
...
You can set up a basic page that is consistent with GOV.UK branding by [using the GOV.UK page template](https://design-system.service.gov.uk/styles/page-template/).
...
Explore the [Styles section](https://design-system.service.gov.uk/styles/) of the Design System to see what classes are available.
